...
class ChooseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val condition = arrayOf("Please Select","Perfect Condition", "Good Condition", "Bad Condition")
        ...
        benzenetype.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View?, position: Int, id: Long) {
                if (position == 0) {
                    Toast.makeText(this@ChooseActivity, "Please select a valid option", Toast.LENGTH_SHORT).show()
            ...
            override fun onNothingSelected(parent: AdapterView<*>) {
                Toast.makeText(this@ChooseActivity, "Please make a selection", Toast.LENGTH_SHORT).show()
            }
        }
